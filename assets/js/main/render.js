...
<<<<<<< HEAD
    // lightController.getLight().position.x = lookat.x;
    light.position.x = lookatX;
    light.position.y = lookatY;
    light.position.z = 1;
    ...
    build: function(scene, camera, planeGeo_, planes_) {
      ...
      setInterval(function() {
        if (Index.getIsMobile() === 0) {
          fireflyTargetX = 0.25 + Math.random(0.5);
          fireflyTargetY = 0.25 + Math.random(0.5);
          // fireflyTargetX = 0.5;
          // fireflyTargetY = 0.5;
        } else {
          fireflyTargetX = 1.25 + Math.random(0.5);
          fireflyTargetY = 0.25 + Math.random(0.5);
          // fireflyTargetX = 1.5;
          // fireflyTargetY = 0.5;
        }
